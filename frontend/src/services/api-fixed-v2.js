...
class APIService {
    ...
    async createProject(data) {
        return await this.request('/projects/projects/new', {
            method: 'POST',
    ...
    async createFromTemplate(data) {
        return await this.request('/templates/projects/projects/from-template', {
            method: 'POST',
            body: JSON.stringify(data)
        });
    }
    ...
    async createBucket(projectName, bucketName) {
        return await this.request(`/projects/projects/${projectName}/buckets/buckets/new`, {
            method: 'POST',
    ...
    async uploadDocument(projectName, bucketName, file) {
        ...
        return await this.request(`/projects/projects/${projectName}/buckets/buckets/${bucketName}/ingest`, {
            method: 'POST',
    ...
    async listBuckets(projectName) {
        return await this.request(`/projects/projects/${projectName}/buckets/buckets`);
    }

    async queryBucket(projectName, bucketName, query, userPrompt = '') {
        return await this.request(`/projects/projects/${projectName}/buckets/buckets/${bucketName}/query`, {
            method: 'POST',
    ...
    async uploadCSV(projectName, tableName, file) {
        ...
        const url = `/projects/projects/${projectName}/tables/upload_csv?project=${projectName}&table_name=${tableName}`;
    ...
    async listTables(projectName) {
        return await this.request(`/projects/projects/${projectName}/tables/list?project=${projectName}`);
    }

    async getTable(projectName, tableName) {
        return await this.request(`/projects/projects/${projectName}/tables/${tableName}?project=${projectName}`);
    }
    ...
    async generateBrainstorm(projectName, data) {
        ...
        return await this.request(`/projects/projects/${projectName}/brainstorm/brainstorm`, {
            method: 'POST',
    ...
    async generateContent(projectName, data) {
        ...
        return await this.request(`/projects/projects/${projectName}/write/write`, {
            method: 'POST',
            body: JSON.stringify(payload)
        });
    }
    ...
    async exportJSON(projectName) {
        return await this.request(`/projects/projects/${projectName}/export/json`);
    }

    async exportCSV(projectName) {
        const response = await fetch(`${this.baseURL}/projects/projects/${projectName}/export/csv`);
        return response.blob();
    }

    async exportComplete(projectName) {
        const response = await fetch(`${this.baseURL}/projects/projects/${projectName}/export/complete`);
        return response.blob();
    }

    // Version management
    async getVersions(projectName, versionType) {
        return await this.request(`/projects/projects/${projectName}/versions/${versionType}`);
    }
